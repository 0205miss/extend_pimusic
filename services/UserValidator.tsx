...
export class UserValidator {
    ...
    public validateRegistrationInput(
        ...
        minPassChars: number
    ): { name: string; email: string; username: string; career: string, genre: string, country: string, password: string } | boolean {
        ...
        // if (!isUserNameValid) {
        //     errors.username = "The username can only contain letters.";
        //     errorDetected = true;
        // }
