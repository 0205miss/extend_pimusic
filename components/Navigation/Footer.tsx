...
export function AdvancedFooter(): ReactElement {
    ...
    return (
        <footer className=" advanced-footer w-screen py-4 px-4 bg-[#232f3e] text-white bottom-0 fixed">
...
export function FooterLink({ title, link, marginLeft }): ReactElement {
    return (
        <Link href={link}>
            <h5
                className={`hover:text-red text-white hover:underline cursor-pointer ${marginLeft ? "ml-4" : ""
                    }`}
            >
                {title}
            </h5>
